...
export default function Testimonial() {
    return (
      <section className="py-12 bg-stone-100 overflow-hidden md:py-20 lg:py-24">
              ...
              <footer className="mt-8">
                <div className="md:flex md:items-center md:justify-center">
                  ...
                  <div className="mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center">
                    ...
                    <svg className="hidden md:block mx-1 h-5 w-5 text-stone-600" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M11 0h3L9 20H6l5-20z" />
                    </svg>
  
                    <div className="text-base font-medium text-stone-500">CEO, Workcation</div>
                  </div>
                </div>
              </footer>
            </blockquote>
